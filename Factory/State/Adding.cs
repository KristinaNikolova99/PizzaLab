...
namespace PizzaBuilding.State
{
    public class Adding : Add
    {
        ...
        public override string AddQuattroFormaggio(Context context, Order order)
        {
            ...
            return "  QuattroFormaggio pizza has been selected";
        }   
